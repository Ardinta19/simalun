...
body{font-family:'Plus Jakarta Sans',sans-serif;color:#1a2332;background:linear-gradient(168deg,#002f5c 0%,#0077b6 50%,#00b4d8 100%);min-height:100vh;display:flex;align-items:center;justify-content:center;padding:24px;overflow:hidden}
...
.code-big{font-weight:800;font-size:clamp(3.4rem,12vw,4.6rem);color:{{ $accent }};letter-spacing:-1px;margin-bottom:6px}
h1{font-weight:800;font-size:clamp(1.4rem,5vw,1.7rem);color:#002f5c;margin-bottom:10px}
