...
body{font-family:'Nunito',sans-serif;color:#1a2332;background:linear-gradient(168deg,#002f5c 0%,#0077b6 50%,#00b4d8 100%);min-height:100vh;display:flex;align-items:center;justify-content:center;padding:24px;overflow:hidden}
